import { QuestionMarkCircleIcon, UsersIcon } from '@heroicons/react/20/solid'
import { TicketIcon } from '@heroicons/react/24/outline'
import { Fragment, JSXElementConstructor, Key, ReactElement, ReactFragment } from 'react'
const ShippingForm = ({
    full_name,
    address_line_1,
    address_line_2,
                ...
                >
                  {
                                ...
                                countries !== null &&
                                countries !== undefined &&
                                countries.map((country: { name: string | number }, index: Key | null | undefined) => (
