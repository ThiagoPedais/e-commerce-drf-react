...
export default function ProductBySold({ data }: any) {
    return (
            ...
            <div className="max-w-7xl mx-auto py-16 px-4 sm:py-24 sm:px-6 lg:px-8">
                ...
                <div className="mt-6 grid grid-cols-1 gap-y-10 sm:grid-cols-3 sm:gap-y-0 sm:gap-x-6 lg:gap-x-8">
                    {
                        ...
                        data !== null &&
                        data !== undefined &&
                        data.map((product: { id: Key; photo: string | undefined; name: string; price: number }) => (
                ...
                <div className="mt-6 sm:hidden">
                    <Link to="#" className="block text-sm font-semibold text-indigo-600 hover:text-indigo-500">
                        more products<span aria-hidden="true"> &rarr;</span>
                    </Link>
                </div>
            </div>
        </div>
