...
const Search = ({ get_categories, categories, get_products, products, get_filtered_products, searched_products, filtered_products }: any) => {
    ...
    const showProducts = () => {
        ...
        if (
            ...
            searched_products .map((product: any, index: React.Key | null | undefined) => {
                return display.push(
                    <div key={index}>
                        <ProductCard product={product} />
                    </div>
