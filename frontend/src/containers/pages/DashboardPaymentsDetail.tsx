                                                ...
                                                <div className="max-w-7xl mx-auto px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
                                                    ...
                                                    <div className="mt-8">
                                                        ...
                                                        <div className="space-y-24">
                                                            {order.order_items.map((product: { id: Key | null | undefined; name: string, transaction_id: string | number, description: string, address_line_1: string | number, address_line_2: string | number, shipping_price: string | number, amount: string | number, status: string | number | boolean; step: number }) => (
                                                                <div
                                                                    key={product.id}
