...
const Shop = ({ get_categories, categories, get_products, products, get_filtered_products, filtered_products }: any) => {
    ...
    // HTMLSelectElement
    const onChange = (e: React.ChangeEvent<HTMLInputElement> | React.ChangeEvent<HTMLSelectElement>) => setFormData({ ...formData, [e.target.name]: e.target.value })
                            ...
                            >
                                <div className="ml-auto relative max-w-xs w-full h-full bg-white shadow-xl py-4 pb-12 flex flex-col overflow-y-auto">
                                    ...
                                    <form onSubmit={e => onSubmit(e)} className="mt-4 border-t border-gray-200">
                                        ...
                                        <button
                                            type="submit"
                                            className="float-right inline-flex items-center px-4 py-2 mr-1 border border-transparent text-sm font-medium rounded-md shadow-sm text-white bg-indigo-600 hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500"
                                        >
                                            Search
                                        </button>
                        ...
                        <div className="relative z-10 flex items-baseline justify-between pt-24 pb-6 border-b border-gray-200">
                            ...
                            <div className="flex items-center">                               
                                ...
                                >
                                    ...
                                    <FilmIcon className="w-5 h-5" aria-hidden="true" />
                                </button>
                            </div>
                        </div>
